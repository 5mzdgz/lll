  ...
  <div class="pay-result">
		...
		<div class="result-box">
			...
			<div class="bottom-box">
				<router-link :to="'/mobile/order/detail?orderId='+orderId">
...
export default {
	...
	mounted () {
		...
		if (this.$route.query.payMethodId === '3' && this.$route.query.total) {
			this.payMethodId = JSON.parse(this.$route.query.payMethodId)
